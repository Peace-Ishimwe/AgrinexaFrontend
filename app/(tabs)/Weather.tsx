...
import SearchSection from '@/components/Tabs/SearchSection';
import ForecastNextDaysSection from '@/components/Tabs/ForecastNextDaysSection';
  ...
  return (
    <View className='flex-1 relative bg-white'>
      ...
      {loading ? (
        ...
        <View>
          <ImageBackground source={require("../../assets/images/Weather/images/bgWeather.png")} style={{ paddingBottom: 18 }}>
            {/* Search section */}
            <SafeAreaView>
