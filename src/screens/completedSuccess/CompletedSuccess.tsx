        ...
        <SafeAreaView className='h-[100vh] bg-mainColor flex justify-between'>
            <View className='justify-between flex items-center'>
                ...
                <View className='pt-[10vh]'>
                    <Image source={require("../../assets/completedIcon.png")} />
                    <View className='pt-[2vh]'>
                        <Text className='text-[26px] font-[700] text-[#fff]'>Welcome back <Text className='text-subMainColor'>Castella,</Text></Text>
                    </View>
