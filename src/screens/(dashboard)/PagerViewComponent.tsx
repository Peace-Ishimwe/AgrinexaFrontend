...
const PagerViewComponent = () => {
    ...
    return (
        <PagerView style={{ flex: 1 }} initialPage={0} ref={pageRef}>
            <View key={1}>
                <Slide
                    imageSource={require('../../assets/dashboard/waterTracking.png')}
            ...
            <View key={2}>
                <Slide
                    imageSource={require('../../assets/dashboard/smartIrrigation.png')}
            ...
            <View key={3}>
                <Slide
                    imageSource={require('../../assets/dashboard/sensorReminder.png')}
