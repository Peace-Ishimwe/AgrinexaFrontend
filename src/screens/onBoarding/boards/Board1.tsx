...
const Board1: React.FC<onBoardingProps> = ({ next }) => {
    ...
    return (
        <View className='h-[100vh] bg-white flex justify-between'>
            <ImageBackground style={{position: "absolute"}} className='h-[76] w-full' source={require('../../../assets/onBoarding/bgImageTop.png')}>
            </ImageBackground>
            <SafeAreaView>
                <View className='main-view px-[35]'>
                    <Ionicons onPress={() => navigation.goBack()} name="arrow-back" size={28} color="black" />
                    <View className='flex flex-row items-center justify-center mt-5'>
                        <Image source={require("../../../assets/onBoarding/smartIrigation.png")} />
                    </View>
