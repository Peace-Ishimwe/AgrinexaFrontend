...
const Welcome = () => {
    ...
    return (
        <ImageBackground source={require("../../assets/Welcome.png")} style={{ flex: 1 }} className='px-[30px]'>
            <StatusBar
                animated={true}
            ...
            <View className='mt-[50px] h-[43vh] flex justify-between px-[10px]'>
                ...
                <View className=''>
                    <Text className='text-[18px] font-medium text-white leading-[27px] text-center'>Make Easy Farming with fast soil & {"\n"}water management system .</Text>
                </View>
            </View>
